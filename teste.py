...
def buscar_dados(ticker: str, period: str, interval: str) -> pd.DataFrame:
    ...
    if df.empty: raise ConnectionError(f"Não foi possível buscar dados para {ticker}/{interval}.")
    ...
    for ticker in Config.TICKERS:
        for interval in Config.INTERVALS:
            ...
            try:
                ...
                pivots_detectados = calcular_zigzag(df_historico, params['deviation'], params['min_distance'])
